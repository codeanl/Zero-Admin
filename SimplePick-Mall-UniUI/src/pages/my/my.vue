  ...
  <scroll-view enable-back-to-top class="viewport" scroll-y>
    ...
    <view class="profile" :style="{ paddingTop: safeAreaInsets!.top + 'px' }">
      ...
      <view class="overview" v-if="memberStore.profile">
        <navigator url="/pages/profile/index" hover-class="none">
          <image class="avatar" :src="memberStore.profile.info.avatar" mode="aspectFill"></image>
        </navigator>
        <view class="meta">
          <view class="nickname">
            {{ memberStore.profile.info.nickname }}
          </view>
          <navigator class="extra" url="/pages/profile/index" hover-class="none">
      ...
      <navigator class="settings" url="/pages/setting/index" hover-class="none">
        设置
      </navigator>
    </view>
    <!-- 我的订单 -->
